...
?> <span class="text-black fw-bold"></span></h1>
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                        ...
                        <a href="{{ Auth::logout() }}" class="dropdown-item"><i
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item"> <a class="nav-link" href="/grutas/edit">Editar</a></li>
                            <li class="nav-item"> <a class="nav-link" href="/grutas/index">Listar</a></li>
                        </ul>
                    </div>
                </li>
            </ul>
    ...
    <footer class="footer">
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Developed by <strong>Duarte
                    Lacerda</strong></span>
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Copyright © <?php echo date('Y'); ?>.
                All rights
                reserved.</span>
        </div>
    </footer>
