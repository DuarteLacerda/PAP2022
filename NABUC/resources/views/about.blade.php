        ...
        <div class="box">
            <div class="row">
                <div class="desc-about">
                    <h2>
                        ...
                        valorizar
                        o
                        meio cavernícula existente no Planalto das Cezaredas e nas áreas envolventes por todos os meios a
                        seu
                        alcance.
                        Em 2014 une-se ao <a href="https://www.facebook.com/cehlourinha">Centro de Estudos Históricos da
            ...
            <div class="row">
                <h2 class="desc2-about">
                    ...
                    pertencente
                    ao período que medeia entre o Cretácico e o Jurássico Médio, quando terminam as violentas convulsões da
                    ...
                    <br><span id="dots">...</span><span id="more">
                        ...
                        transforma
                        algumas das montanhas, em colinas baixas, com extensos bancos calcários, quando se inicia a extinção
                        dos
                        dinossáurios, das amonites e outras espécies animais e vegetais.
                        A área global do Planalto, ronda hoje os 9.600 hectares, incluindo pela sua continuidade, o Monte do
                        Picoto
                        no concelho do Bombarral, com uma altitude média na ordem dos 145 metros. O Planalto, estende-se ao
                        longo de
                        doze quilómetros de comprimento com dez de largura, uma área que abrange parte dos concelhos de
                        Óbidos
                        (freguesia do Olho Marinho), Peniche (freguesia de Serra d'El-Rei), assim como uma parte bastante
                        ...
                        As amonites, faziam parte de uma espécie marinha, que ocupou o nicho ecológico das actuais lulas,
                        animais
                        com dimensões variáveis, desde alguns centímetros a 1 metro de diâmetro, que viviam dentro de uma
                        concha
                        espiralada de natureza carbonatada, semelhante à dos actuais Náutilos.Os Paleontólogos, estimam que
                        o
                        Planalto das Cesaredas terá começado há cerca de 160 milhões de anos, quando o mar começa a recuar
                        nesta
                        zona, provavelmente, quando se iniciou a formação das várias espécies fossilizadas, onde se destacam
                        as
                        Amonites (fósseis de espécies marinhas, que terão desaparecido há cerca de 65 milhões de anos, na
                        mesma
